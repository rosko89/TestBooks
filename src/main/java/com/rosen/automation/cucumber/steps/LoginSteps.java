...
import com.rosen.automation.pageobjects.LoginPage;
...
public class LoginSteps {
	...
	@Then("^I'm logged in$")
	public void checkLoginStatusIsLoggedIn() throws Throwable {//
		Assert.assertTrue(true);// to think
	}
	
	@Then("^I'm not logged in$")
	public void checkLoginStatusIsUnlogged() throws Throwable {
